...
/**
 * @notice Implementation of the AipxGovernance token contract
 */
contract AipxGovernance is Initializable, GovernancePowerDelegationERC20 {
    ...
    function initialize() external initializer {
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                EIP712_DOMAIN,
                keccak256(bytes("AipxGovernance")),
        ...
        __ERC20_init("Aipx Governance Token", "AGO");
